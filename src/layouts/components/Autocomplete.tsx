...
const AutocompleteComponent = ({ hidden, setShowBackdrop }: Props) => {
  ...
  const handleAutocompleteChange = (event: SyntheticEvent, obj: any | unknown) => {
        ...
        <Box ref={wrapper}>
          ...
          >
            <Autocomplete
              ...
              groupBy={(option: any | unknown) => (option).type}
              getOptionLabel={(option: any | unknown) => (option).title}
