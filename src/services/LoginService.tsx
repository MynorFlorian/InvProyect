...
export default class LoginService {
    ...
    async login(username: string, password: string) {
        try {
            ...
            // Url construction
            let url = Statics.instance.urlBase + Statics.instance.usersUrl + '/login-web';
            ...
            await this.storage.recordToken({ token, rolType: 'admin' });
    ...
    async refreshToken(oldToken: string) {
        try {
            ...
            // Url construction
            let url = Statics.instance.urlBase + Statics.instance.usersUrl + '/refreshLogin';
    ...
    async fcmToken() {
        try {
            ...
            // Url construction
            let url = Statics.instance.urlBase + Statics.instance.usersUrl + '/saveWebToken';
            console.log('url: ', url)
    ...
    async register(user: UserData) {
        try {
            ...
            // Url construction
            let url = Statics.instance.urlBase + Statics.instance.usersUrl + '/registrar';
